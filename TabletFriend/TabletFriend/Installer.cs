    ...
    public static class Installer
    {
        ...
        public static void TryInstall()
        {
            ...
            var result = MessageBox.Show(
                "Welcome to Tablet Friend! See the https://github.com/Faeq-F/TabletFriend#readme if you have any questions. Would you like to move Tablet Friend to AppData?",
                "Hello",
                ...
                try
                {
                    if (Directory.Exists(_preferredDirectory))
                    {
                        MessageBox.Show(
                            ...
                            "If you have your own layouts you will need to update them manually. See https://github.com/Faeq-F/TabletFriend#readme for the instructions.",
                            "Update",
                            MessageBoxButton.OK
                        );
